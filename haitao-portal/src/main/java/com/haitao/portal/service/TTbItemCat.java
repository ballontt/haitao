...
public class TTbItemCat implements org.apache.thrift.TBase<TTbItemCat, TTbItemCat._Fields>, java.io.Serializable, Cloneable, Comparable<TTbItemCat> {
  ...
  public String updated; // required
  ...
  public TTbItemCat setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public TTbItemCat setCreated(String created) {
    this.created = created;
    return this;
  }
  ...
  public TTbItemCat setUpdated(String updated) {
    this.updated = updated;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TTbItemCat(");
    boolean first = true;
